      ...
      <div class="sidebar sidemenu">
         <div class="sidebar-wrapper" style="background-color:#323546;">
            ...
            <ul class="nav" >
               ...
               <li id="task">
                  <a data-toggle="collapse" href="#taskmenu">
                     <img class="menuimg" src="<?php echo base_url(); ?>assets/img/icons/teachers.png"/>
                     <p>Task	</p>
                     <b class="caret"></b>
                  </a>
                  <div class="collapse" id="taskmenu">
                     <ul class="nav">
                        <li id="task1"><a href="<?php echo base_url(); ?>stafftask/home">Add task</a></li>
                        <li id="task2"><a href="<?php echo base_url(); ?>stafftask/view">View Task</a></li>

                     </ul>
                  </div>
               </li>
               <li id="study">
                  <a data-toggle="collapse" href="#studymenu">
                     <img class="menuimg" src="<?php echo base_url(); ?>assets/img/icons/teachers.png"/>
                     <p>Study Material	</p>
                     <b class="caret"></b>
                  </a>
                  <div class="collapse" id="studymenu">
                     <ul class="nav">
                        <li id="study1"><a href="<?php echo base_url(); ?>studymaterial/home">Create Study Material</a></li>
                        <li id="study2"><a href="<?php echo base_url(); ?>studymaterial/view">View Study Material</a></li>
               ...
               <li id="discussion">
                  <a data-toggle="collapse" href="#discussionmenu">
                     <img class="menuimg" src="<?php echo base_url(); ?>assets/img/icons/circular.png"/>
                     <p>Discussion Forum</p>
                     <b class="caret"></b>
                  </a>
                  <div class="collapse" id="discussionmenu">
                     <ul class="nav">
                        <li id="discussion1"><a href="<?php echo base_url(); ?>discussion/home">Create Forum</a></li>
                        <!-- <li id="discussion2"><a href="<?php echo base_url(); ?>circular/view_circular">View Circular </a></li> -->
                     </ul>
                  </div>
               </li>
               <li id="grouping">
               ...
               <li id="polling">
                  <a data-toggle="collapse" href="#pollmenu">
                     <img class="menuimg" src="<?php echo base_url(); ?>assets/img/icons/teachers.png"/>
                     <p>Polling	</p>
                     <b class="caret"></b>
                  </a>
                  <div class="collapse" id="pollmenu">
                     <ul class="nav">
                        <li id="poll1"><a href="<?php echo base_url(); ?>polling/home">Create Poll</a></li>
                        <li id="poll2"><a href="<?php echo base_url(); ?>polling/view">View Polling</a></li>
