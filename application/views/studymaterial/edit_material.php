         ...
         <div class="card">
            ...
            <div class="content">
              <?php  foreach($res as $rows){} ?>
               <form method="post" action="" class="form-horizontal" enctype="multipart/form-data" id="stafftask" name="studymaterial">
                 <fieldset>
                    <div class="form-group">
                       <label class="col-sm-2 control-label">Select Role </label>
                       <div class="col-sm-6">
                         <select name="class_id" id="class_id" class="selectpicker form-control"  data-style="btn-default btn-block" data-menu-style="dropdown-blue" onchange="get_class_id()">
                         ...
                         <?php   } ?>
                             ...
                             <script language="JavaScript">document.studymaterial.class_id.value="<?php echo $rows->class_id; ?>";</script>
                       </div>
                    </div>
                 </fieldset>
                 <fieldset>
                    ...
                    <fieldset>
                       <div class="form-group">
                          ...
                          <div class="col-sm-6">
                             <input type="text" name="e_title" class="form-control " value="<?php echo $rows->e_title; ?>">
                    ...
                    <fieldset>
                       <div class="form-group">
                          ...
                          <div class="col-sm-6">
                             <textarea type="text" name="e_desc" class="form-control"><?php echo $rows->e_desc; ?></textarea>
                          </div>
                       </div>
                    </fieldset>
                    <fieldset>
                       <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <select name="status" id="status" class=" form-control">
                             ...
                             <script language="JavaScript">document.studymaterial.status.value="<?php echo $rows->status; ?>";</script>
                          </div>
                       </div>
                    </fieldset>
  ...
  submitHandler: function(form) {
    swal({
              ...
              function(isConfirm) {
                  if (isConfirm) {
   $.ajax({
       url: "<?php echo base_url(); ?>studymaterial/update_material",
        type:'POST',
