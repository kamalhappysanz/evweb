                 ...
                 <fieldset>
                  ...
                  <fieldset>
                     <div class="form-group">
                        ...
                        <div class="col-sm-4">
                           <input name="previous_institute" type="text"  class="form-control"  placeholder="Previous Institute" value="<?php echo $rows->previous_institute; ?>">
                        </div>
                        <label class="col-sm-2 control-label">Total Year Of Experience</label>
                        <div class="col-sm-4">
                           <input name="total_year_of_experience" type="text" class="form-control"  placeholder="Total Year Of Experience" value="<?php echo $rows->total_year_of_experience; ?>">
                        </div>
                     </div>
                  </fieldset>
                  <fieldset>
                     <div class="form-group">
                        ...
                        <div class="col-sm-4">
                           <input name="skillsets" type="text"  class="form-control"  placeholder="Skill Sets" value="<?php echo $rows->skillsets; ?>">
                            <small>E.g:Dancing,Sports</small>
                        </div>
                        <label class="col-sm-2 control-label">Resume</label>
                        <div class="col-sm-4">
                           <input name="old_user_resume"  type="hidden" class="form-control" value="<?php echo $rows->user_resume; ?>">
                           <input name="user_resume"  type="file" class="form-control" accept=".pdf,.doc">
                           <?php if(empty($rows->user_resume)){ ?>

                        <?php   }else{ ?>
 <p><a href="<?php echo base_url(); ?>assets/staff/resume/<?php echo $rows->user_resume; ?>" class="control-label">View Resume</a></p>
                        <?php   } ?>
